        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="mb-6 md:mb-0">
              ...
              <p className="text-gray-300 mt-3">Your comprehensive campus events platform. Discover, create, and manage events with ease.</p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-300">123 University Avenue<br />Campus District, CA 90210</span>
                </li>
                <li className="flex items-center">
                  ...
                  <a href="mailto:info@eventnow.com" className="text-gray-300 hover:text-white transition-colors">info@eventnow.com</a>
                </li>
                <li className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
