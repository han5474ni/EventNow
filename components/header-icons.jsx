...
import { Bell, User, Check, ChevronRight, Settings, LogOut } from "lucide-react"
...
const userData = {
  ...
  profileImage: null, // Set to null to use the default user icon
}
...
export default function HeaderIcons() {
  ...
  const [unreadCount, setUnreadCount] = useState(notificationsData.filter((notification) => !notification.read).length)
  ...
  const handleLogout = () => {
    ...
    // For example: auth.signOut() or similar
  ...
  return (
    <div className="flex items-center gap-4">
      ...
      <div className="relative" ref={notificationRef}>
        ...
        <div
          className={`absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg overflow-hidden z-50 transition-all duration-200 origin-top-right ${
      ...
      <div className="relative" ref={profileRef}>
        <button
          ...
          className="flex items-center justify-center h-10 w-10 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors focus:outline-none"
        ...
        <div
          className={`absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-lg overflow-hidden z-50 transition-all duration-200 ${
            profileOpen ? "transform scale-100 opacity-100" : "transform scale-95 opacity-0 pointer-events-none"
          }`}
        >
          <div className="p-4 border-b border-gray-200">
